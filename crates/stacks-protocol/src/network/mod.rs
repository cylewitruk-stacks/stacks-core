...
pub use mainnet::{
    ...
    BITCOIN_MAINNET_STACKS_34_BURN_HEIGHT, C32_ADDRESS_VERSION_MAINNET_MULTISIG,
    C32_ADDRESS_VERSION_MAINNET_SINGLESIG, epoch_schedule as mainnet_epoch_schedule,
};
...
pub use testnet::{
    ...
    BITCOIN_TESTNET_FIRST_BLOCK_TIMESTAMP, BITCOIN_TESTNET_STACKS_2_05_BURN_HEIGHT,
    ...
    epoch_schedule as testnet_epoch_schedule,
};
