# Legacy v1alpha1 qualification inputs

The supported Attacknet interface is the typed Go client and the
`testing.stacks.org/v1beta1` API. Shell and JavaScript under [`runtime/`](runtime/)
are internal qualification inputs for historical packets,
...
Historical release packet tooling remains under [`../../release/`](../../release/)
because approved
