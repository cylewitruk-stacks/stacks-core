...
const ATTACKNET_ROOT = resolve(ROOT, '..', '..', '..');
  ...
  const actors = [
    {
      ...
      config: {files: {'bitcoin.conf': readFileSync(join(ATTACKNET_ROOT, 'config', 'bitcoin', 'bitcoin.conf'), 'utf8')}, key: 'bitcoin.conf', mountPath: '/home/bitcoin/.bitcoin'},
