...
const dockerfile = readFileSync(new URL('../../images/cli/Dockerfile', import.meta.url), 'utf8');
const dockerignore = readFileSync(new URL('../../images/cli/Dockerfile.dockerignore', import.meta.url), 'utf8');
